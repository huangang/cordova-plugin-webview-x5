module.exports = function (context) {
  ...
  let mainContent = fs.readFileSync(path.join(context.opts.projectRoot, 'plugins/@youtuosoft/cordova-plugin-webview-x5/platforms/android/template/OriginMainActivity.java'), 'utf8')
